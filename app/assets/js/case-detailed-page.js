...
function caseDetailedPage() {
  ...
  getDocument(linkPrevPage.href, function(doc) {
    ...
    elemSideLeft.onclick = slidePrevPage;
  });
  ...
  function slideNextPage(event)
  {
    ...
    history.replaceState('', '', linkNextPage.href);
    ...
    requestAnimationFrame(function(){
      ...
      elemArticle.style.transition = 'all 1000ms ease 200ms, opacity 800ms';
  ...
  function slidePrevPage() {
    ...
    history.replaceState('', '', linkPrevPage.href);
    ...
    requestAnimationFrame(function(){
      ...
      elemArticle.style.transition = 'all 1000ms ease, opacity 800ms';
      elemArticle.style.transform  = 'translateX(50rem)';
      elemArticle.style.opacity    = 0;
  ...
  function clearStyle() {
    ...
    elemSideLeft.removeAttribute('style');
    ...
    linkNextPage.removeAttribute('style');
    linkPrevPage.removeAttribute('style');
  }
